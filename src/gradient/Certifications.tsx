...
const CERTIFICATIONS = [
  ...
  { title: 'Enterprise Design Thinking', issuer: 'IBM SkillsBuild', period: 'Jul 2026', link: 'https://drive.google.com/file/d/1E7on5dG25BTiiWlbQe80hnIwtyPzcEO4/view?usp=sharing' },
  { title: 'IBM SkillsBuild Course Completion', issuer: 'IBM SkillsBuild', period: 'Jul 2026', link: 'https://drive.google.com/file/d/1swWQJ-UKEpw3QkTzZFGn-295iszi544f/view?usp=sharing' },
