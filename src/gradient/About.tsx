        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <p className="text-[var(--text-muted)] text-[16px] leading-[1.8] mb-10">
              Adept at leveraging AI-assisted workflows to rapidly prototype and deploy complex applications. Known for deep debugging (30+ fixes, logic bugs, etc. in frontend and backend) and ensuring seamless integration between physical sensors and cloud logic.
            </p>
